...
function marcarAciertosPerfil() {
    if (typeof perfilNombre === 'undefined' || !perfilNombre) return; // Solo para páginas de perfil
    if (typeof perfilesConfig === 'undefined' || !perfilesConfig?.partidos?.key) return;
    if (typeof cargarPronosticosPorClave !== 'function') return;
